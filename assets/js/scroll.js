...
const generateScrollBlock = function (array) {
    ...
    for (scroll of array) {
        result += `<div class="mt-3 combination-box" data-id="${scroll.slice(0, 3)}"><div><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[scroll[0]]}.png"><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[scroll[1]]}.png"><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[scroll[2]]}.png"></div><div class="scroll-type">${scrollTypeList(scroll)}</div></div>\n`
    }
    return result;
}
...
const craftScroll = function (searchAny = false) {
    ...
    if (searchAny == true) {
        ...
        SCROLL_COMBINATIONS.forEach(function (scroll) {
            ...
            results += `<div class="mt-3 combination-box" data-id="${weapons}"><div><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[weapons[0]]}.png"><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[weapons[1]]}.png"><img src="/assets/images/toramonline/wepicon/${WEAPON_ICONS[weapons[2]]}.png"></div><div class="scroll-type">${skillList(scroll)}</div></div>\n`
        });
...
$(document).ready(function () {
    ...
    $("#results-popup").on("click", function () {
        alert("For more details, click on a combination.");
    });
