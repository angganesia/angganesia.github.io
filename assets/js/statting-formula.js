...
const OPTIONS = [
  ...
  { "name": "Reduce Dmg (Foe Epicenter) %", "mat": "Metal", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Player Epicenter) %", "mat": "Metal", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Straight Line) %", "mat": "Wood", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Charge) %", "mat": "Wood", "pot": 6, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Meteor) %", "mat": "Wood", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Bullet) %", "mat": "Wood", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Bowling) %", "mat": "Wood", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a"},
  { "name": "Reduce Dmg (Floor) %", "mat": "Wood", "pot": 4, "cost": 15, "cat": "Enhance Defense", "type": "a"},
...
class SIMULATOR {
    ...
    getStatData(value_name) {
        ...
        if (data.name === 'Aggro %' || data.name === 'MaxMP') data.maxSteps = 22;  // for some reason this only goes up to +15/-15 go figure.
